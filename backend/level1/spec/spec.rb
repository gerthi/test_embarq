...
describe "TESTS LEVEL 1" do
    before(:all) do
        @car1 = Car.new({ "id"=> 1, "price_per_day"=> 2000, "price_per_km"=> 10 })
        @rental1 = Rental.new( { "id"=> 1, "car_id"=> 1, "start_date"=> "2017-12-8", "end_date"=> "2017-12-10", "distance"=> 100 })
    end
    ...
    context "- Rental model" do
        ...
        it 'is initialized with the correct price' do
            expect(@rental1.price).to eq 7000
        end
